  ...
  return (
    <PageWrapper>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-12">
            {valores.map((v, i) => (
              <ScrollReveal key={v.label} delay={i * 0.08}>
                <div className="bg-umad-cream rounded-2xl p-6 text-center hover:shadow-md transition-shadow">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mt-12">
            ...
            <div className="space-y-6">
              {hitos.map((h, i) => (
                <ScrollReveal key={h.year} delay={i * 0.08}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {alianzas.map((a, i) => (
              <ScrollReveal key={a.name} delay={i * 0.08}>
                <div className={`rounded-2xl border p-6 text-center ${a.color}`}>
      ...
      <div className="py-20 bg-umad-navy">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading title="Acreditaciones" subtitle="Calidad educativa respaldada por organismos nacionales e internacionales." light center />
